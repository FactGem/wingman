...
FactGem.wingman = (function namespace() {
    ...
    Comparison.prototype.anyInArray = function (subVariable, value) {
        // any(t1 in person.tag WHERE t1 in ['Dog Owner']) - variable = person, property = tag
        this.comparisonOperator = 'ANY';
        this.subVariable = subVariable;
        this.comparisonValue = value;
        return this;
    };

    Comparison.prototype.notAnyInArray = function (subVariable, value) {
        // not any(t1 in person.tag WHERE t1 in ['Dog Owner']) - variable = person, property = tag
        this.comparisonOperator = 'NOT ANY';
        this.subVariable = subVariable;
        this.comparisonValue = value;
        return this;
    };
    ...
    Comparison.prototype.toString = function () {
        ...
        switch (this.comparisonOperator) {
            ...
            case "NOT HAS":
                ...
                break;
            case "ANY":
                // any(t1 in person.tag WHERE t1 in ['Dog Owner'])
                value += "ANY(" + this.subVariable + " in " + this.comparisonVariable + "." + this.comparisonProperty
                + " WHERE " + this.subVariable + " in ['" + this.comparisonValue + "'])";
                break;
            case "NOT ANY":
                // any(t1 in person.tag WHERE t1 in ['Dog Owner'])
                value += "NOT ANY(" + this.subVariable + " in " + this.comparisonVariable + "." + this.comparisonProperty
                + " WHERE " + this.subVariable + " in ['" + this.comparisonValue + "'])";
                break;
            default:
                value = "";
