describe("Cypher", function () {
    ...
    it("produces correct parameterized cypher using fluid match and where syntax", function () {
        cypher = new FactGem.wingman.Cypher();
    ...
    it("produces correct parameterized cypher using fluid match, where and single return", function () {
        cypher = new FactGem.wingman.Cypher();
        var match = new FactGem.wingman.Match();
    ...
    it("produces correct parameterized cypher using fluid match, where and multiple returns", function () {
        cypher = new FactGem.wingman.Cypher();
        var match = new FactGem.wingman.Match();
        match.startNode(new FactGem.wingman.Node('p', 'Person'))
            .relationship(new FactGem.wingman.Relationship('r', 'hasResidentialAddress', 'outgoing'))
    ...
    it("produces correct parameterized cypher using fluid match, where and multiple returns and order by", function () {
        cypher = new FactGem.wingman.Cypher();
        var match = new FactGem.wingman.Match();
        match.startNode(new FactGem.wingman.Node('p', 'Person'))
            .relationship(new FactGem.wingman.Relationship('r', 'hasResidentialAddress', 'outgoing'))
    ...
    it("produces correct parameterized cypher using fluid match, where and multiple returns and order by desc", function () {
        cypher = new FactGem.wingman.Cypher();
        var match = new FactGem.wingman.Match();
        match.startNode(new FactGem.wingman.Node('p', 'Person'))
            .relationship(new FactGem.wingman.Relationship('r', 'hasResidentialAddress', 'outgoing'))
    ...
    it("produces correct parameterized cypher using fluid match, where and multiple returns, order by and skip", function () {
        cypher = new FactGem.wingman.Cypher();
        var match = new FactGem.wingman.Match();
        match.startNode(new FactGem.wingman.Node('p', 'Person'))
            .relationship(new FactGem.wingman.Relationship('r', 'hasResidentialAddress', 'outgoing'))
    ...
    it("produces correct parameterized cypher using match, optional match, where and multiple returns, order by, skip and limit", function () {
        ...
        expect(cypher.toParameterizedString()).toEqual('match (p:Person)-[r:hasResidentialAddress]->(pl:Place) where pl.city<>{city1} optional match (p:Person)-[r2:hasMailingAddress]->(pl:Place) where pl.city<>{city1} return distinct p, pl.city order by p.familyName skip 10 limit 100;');
    });

    it("produces correct parameterized cypher using fluid match, where and multiple returns, order by, skip and limit", function () {
        cypher = new FactGem.wingman.Cypher();
        var match = new FactGem.wingman.Match();
        match.startNode(new FactGem.wingman.Node('p', 'Person'))
            .relationship(new FactGem.wingman.Relationship('r', 'hasResidentialAddress', 'outgoing'))
